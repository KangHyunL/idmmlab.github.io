...
본 연구실은 인공지능 기반 설계, 멀티피직스 시뮬레이션, 첨단 제조에 관심 있는 **석·박사 대학원생**과 **학부 연구생**을 모집하고 있습니다. 세 분야 모두에 능숙할 필요는 없습니다 — (a) 머신러닝/과학적 계산, (b) 역학/재료, (c) 제조/CAD/시뮬레이션 중 **한 분야**에 단단한 기초가 있다면 충분히 합류할 수 있습니다.
...
**Email.** [kanghyun.lee@ssu.ac.kr](mailto:kanghyun.lee@ssu.ac.kr)
